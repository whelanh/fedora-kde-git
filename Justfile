...
export image_desc := env("IMAGE_DESC", "Fedora KDE Git - Custom bootc image with KDE git master builds and development toolchain")
export image_keywords := env("IMAGE_KEYWORDS", "bootc,fedora,kde,plasma,development")
